...
npx tsx scripts/check-edge-layer-seam-history-public-artifacts.ts \
  --run-dir proof-artifacts/public-hyperswarm-single-machine-2026-06-01 \
  --output proof-artifacts/public-hyperswarm-single-machine-2026-06-01/public-artifact-reproducibility-check.json
```
