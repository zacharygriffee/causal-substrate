# Generic Causal Seam Public Swarm Duplicate Id Run

Date: 2026-06-03

This directory preserves a Causal-owned generic public-swarm seam run using
neutral seam-history material that is intentionally damaged: two request
records carry the same request id.
...
- classified happening: `duplicate_id`
- strongest proof rung: `durable_replicated_public_swarm_seam`
- damage finding: `duplicate request id generic-request:2026-06-03:duplicate-id`
